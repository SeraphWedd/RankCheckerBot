...
def get_headers(path):
    headers = {'authority': 'www.webnovel.com', 'method': 'GET', 'scheme': 'https', 'Accept': 'application/json, text/javascript, */*; q=0.01', 'Accept-Encoding': 'gzip, deflate, br, zstd', 'Accept-Language': 'en-US,en;q=0.9', 'Cookie': 'webnovel-language=en; webnovel-content-language=en; bookCitysex=1; show_gift_tip=1; para-comment-tip-show=1; show_lib_tip=1; QDReport_utm=utm_source%3DnoahActivity; __zlcmid=1LImeDfz2451vVV; NEXT_LOCALE=en; wn_show_first_charge_modal=; charge_selected_payments=paypal; _csrfToken=45461292-696a-4b90-ba12-72ce2a3e7d13; uid=4300026489; ukey=uXnz1f67uhq; webnovel_uuid=1719526890_1946123745; _fsae=1719580024477; checkInTip=1; e2=%7B%22pid%22%3A%22bookstore%22%2C%22l1%22%3A%2299%22%7D; e1=%7B%22pid%22%3A%22bookstore%22%2C%22l1%22%3A%221%22%2C%22eid%22%3A%22qi_A_home_rankingshoverclick%22%7D', 'Priority': 'u=1, i', 'Referer': 'https://www.webnovel.com/ranking/novel/all_time/best_sellers', 'Sec-Ch-Ua': '"Not/A)Brand";v="8", "Chromium";v="126", "Google Chrome";v="126"', 'Sec-Ch-Ua-Mobile': '?0', 'Sec-Ch-Ua-Platform': '"Windows"', 'Sec-Fetch-Dest': 'empty', 'Sec-Fetch-Site': 'same-origin', 'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/126.0.0.0 Safari/537.36', 'X-Requested-With': 'XMLHttpRequest'}
    headers['path'] = path
